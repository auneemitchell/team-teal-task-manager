-- reset all tables except for migration and customers
...
-- reset AUTOINCREMENT counters (safe if sqlite_sequence exists)
DELETE FROM sqlite_sequence
WHERE name IN (
  'Users','Projects','Sprints','Columns','Tasks','Column_Tasks','Comments'
);
